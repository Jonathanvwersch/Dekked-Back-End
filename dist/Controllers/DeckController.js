    ...
    createDeck(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (folder_id && name) {
                    const response = yield DeckModel_1.default.createDeck({ folder_id, name });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (req.params.deck_id) {
                    const response = yield DeckModel_1.default.getDeck(req.params.deck_id);
                    return res.status(200).json({
                        success: true,
                        data: response
                    });
    ...
    getDecksInFolder(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield DeckModel_1.default.getDecksInFolder(req.params.folder_id);
