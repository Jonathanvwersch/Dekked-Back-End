    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const fullFlashcards = yield Promise.all(flashcards.map((val) => __awaiter(this, void 0, void 0, function* () {
                const blocksInCard = yield BlockModel_1.default.getBlocksByParentId(val.id);
...
function saveFlashcard(flash_card_id, owner_id, front_blocks, front_draft_keys, back_blocks, back_draft_keys) {
    return __awaiter(this, void 0, void 0, function* () {
