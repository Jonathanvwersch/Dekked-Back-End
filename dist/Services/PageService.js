...
function getPageByStudySetIdAsync(study_set_id) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      const result = yield PageModel_1.default.getPageByStudySetId(
        study_set_id
      );
      return result;
    } catch (error) {
...
function createPage(study_set_id, title, owner_id) {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      const result = yield PageModel_1.default.createPage(
        study_set_id,
        title,
        owner_id
      );
